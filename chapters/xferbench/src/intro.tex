...
\unskip\footnote{Based on ``XferBench: a Data-Driven Benchmark for Emergent Language'' appearing in the \emph{Proceedings of the 2024 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies (Volume 1: Long Papers)} \citep{boldt2024xferbench}.}
\end{abstract}
