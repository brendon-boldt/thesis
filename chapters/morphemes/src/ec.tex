...
\begin{description}[nosep,itemindent=-1em]
  ...
  \item[Morpheme bijectivity]
    ...
    See \cmt{reference phrasebook chapter} for the introduction of this metric.
