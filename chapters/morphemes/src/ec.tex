...
Within each of the environments, further signaling game variations are described below.


\paragraph{Vector observations}
In the vector observation signaling game (based on the EGG framework \citep{egg}) the agents directly observe one-hot vectors without having to further extract representations.
...
For both observation spaces, we also test two variations of the signaling game.
