...
Starting with the task of morpheme induction aligns this work with a broadly bottom-up, structuralist approach to linguistics insofar as we are trying to discover low-level meaningful units which can later be composed into more complex structures.
This is in contrast to top-down accounts of language acquisition which emphasize the importance of context in determining meaning.
We argue that a bottom-up approach is more appropriate, at least initially, since it makes fewer assumptions about the nature of form and meaning in emergent language, whose structure has been shown to diverge from that of human language \citep{kottur2017natural,lake2018generalization,chaabouni2019antiefficient}.
This choice mirrors the study of interpretability in deep learning more broadly, which entails explaining high level behavior in terms of the interaction of low-level parts (e.g., explaining the interpretation of utterances in terms of minimal pairs of form and meaning).
