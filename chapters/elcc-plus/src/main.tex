...
\phantom{}%
\cmt{ELCC, obviously}
\cmt{General RL trajectory storage format.}
\cmt{Semantic annotation of any sort in EC research.}
...
\begin{figure}
  ...
  \caption{A visualization of the BabyAI navigation environment \protect\cmt{cite}.}
\end{figure}
