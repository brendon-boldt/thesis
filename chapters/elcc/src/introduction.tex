...
In a typical paper studying emergent language, one of the major components involves implementing a particular emergent language environment which will be used for empirically testing the properties of emergent communication.
