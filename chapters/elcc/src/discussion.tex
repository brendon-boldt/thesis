...
Additionally, \theLib{} can similarly extend the range of emergent languages evaluated in the context of machine learning, such as \citet{yao2022linking} and \cref{ch:xferbench} which look at emergent language's suitability for deep transfer learning to downstream NLP tasks or \citet{van-der-wal-etal-2020-grammar} which analyzes emergent languages with unsupervised grammar induction.
...
% \cmt{For example, we in RLupus we have [password signaling] which suggests that there is a degenerate strategy to winning.}
