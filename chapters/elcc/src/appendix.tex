...
\begin{description}[itemindent=-0.2in]
    ...
    \item[game\_type] The high level category of the game implemented in the ECS\@; currently one of \emph{signaling}, \emph{conversation}, or \emph{navigation}.
