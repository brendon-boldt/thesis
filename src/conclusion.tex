...
\cmt{Explicitly discuss CEL somewhere in here.}
\cmt{Also bring up thesis statement.}
...
\cmt{Future work should look at building upt he paradigm of DEL (how research is done, how assumptions are made) and not just variations on the same theme (related to the blight of ``we made a new environment and saw what happened'')}.
\cmt{How does this thesis help with the above meta question?  I think it is again providing methods of finding the kind of structures that make DEL more comparable to CEL.}
...
\cmt{Suggest that maybe the outputs of LLMs can be treated like emergent language and the techniques and considerations I present will still apply.}
