...
Emergent communication, as a method, has significant potential applications from powering unprecedentedly detailed simulations of how humans invent, acquire, and use language
  to providing rich, embodied language data for training and evaluating deep learning models free of contamination or surveillance.
...
As a result, research findings are often ``one-off'', unable build on prior work or produce generalizable contributions.
