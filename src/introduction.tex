...
\chapter*{Prologue}
%%%%%%%%%%%%%%%%%%%
\cmt{Write this for 2018 really when the thesis starts; make some explicit mention of it starting then.}
The year is 2016.
...
The first comprises \cref{ch:elcc} \cmt{fix removing rich corpora}, which introduce a large collection of emergent language corpora and corresponding semantic annotations.
