...
\begin{figure}
  ...
  \unksip\label{fig:signaling-game}
\end{figure}
...
\cmt{Include signalling game figure from review channel.}
...
While normal science (as Kuhn terms it \cmt{cite}) often proceeds by small, additive research contributions, emergent communication has not developed paradigm where the small contributions can truly add together.
...
Such an approach was addressed by my paper \cmt{name} \cmt{cite} which was a sort of proof-of-concept for this approach, attempting to establish an empirically verifiable formal model of certain behaviors in emergent communication experiments.
...
If this is true, and my intuition pushes me in this direction, then emergent communication, \emph{qua} emergent phenomenon, is a matter of ``go big or go home'': scale up or pack up.\footnote{This sounds like a bitter lesson. \cmt{cite}}
...
Second, \Cref{ch:xferbench,ch:xferbench-analysis} introduce and showcase XferBench, a deep transfer learning-based evaluation metric for emergent language corpora.
...
\Cref{ch:xferbench,ch:xferbench-analysis} introduce XferBench, an evaluation metric for emergent language corpora based on deep transfer learning.
